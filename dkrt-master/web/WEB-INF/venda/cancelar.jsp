...
<br><br><br><h1 class="geral">CANCELAR VENDA</h1><br>
			...
			<form method="post" action="#">
				...
				<div id="codigo" style="visibility:hidden;">
					<label>Número do pedido:<input type="text" value="PD0001" style="text-align: center" name="codigo" class="form-control"  disabled="disabled"/></label><br>
						...
						<label>Valor:<input value="6.700" type="number" name="total" class="form-control" disabled="disabled"  disabled="disabled"></label>
						<label>Desconto:<input value="0" type="number" name="desconto" class="form-control"  disabled="disabled"></label>
						<label>Total:<input value="6.700" type="number" name="total" class="form-control" disabled="disabled"  disabled="disabled"></label><br><br>
